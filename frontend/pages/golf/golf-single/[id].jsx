...
import GolfSnapShot from "../../../components/golf-single/GolfSnapShot";
...
import ReviewProgress2 from "../../../components/golf-single/guest-reviews/ReviewProgress2";
import DetailsReview2 from "../../../components/golf-single/guest-reviews/DetailsReview2";
import ReplyForm from "../../../components/golf-single/ReplyForm";
import ReplyFormReview2 from "../../../components/golf-single/ReplyFormReview2";
...
import ImportantInfo from "../../../components/golf-single/ImportantInfo";
...
const GolfSingleV1Dynamic = () => {
  ...
  useEffect(() => {
    ...
    else 
    {
      ...
      axios.get(`${baseURL}/golfs/${id}`).then((response) => {
...
console.log("golf/golf-single/1", golf.data)
        ...
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <h1 className="text-30 fw-600">{golf?.data?.title}</h1>
                ...
                <div className="col-auto">
                  <div className="d-flex items-center">
                    ...
                    <div className="text-14 text-light-1 ml-10">
                      {golf?.data?.numberOfReviews} reviews
                    </div>
                  </div>
                </div>
          ...
          <div className="row y-gap-30">
            <div className="col-xl-8">
              <div className="relative d-flex justify-center overflow-hidden js-section-slider">
                ...
                >
                  {golf?.data?.gallery_img?.map((slide, i) => (
                    <SwiperSlide key={i}>
                      <Image
                        width={451}
                        height={450}
          ...
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Most Popular Golfs</h2>
