...
import HolidayRentalHeader from "@/components/header/holiday-rental-header";
import HolidayRentalHero from "@/components/hero/holiday-rental-hero";
import BlockGuide from "@/components/block/BlockGuide";
import Subscribe from "@/components/rentals/Subscribe";
import Blog from "@/components/rentals/Blog";
import Counter from "@/components/counter/Counter3";
import Testimonial from "@/components/rentals/Testimonial";
import TopDestinations from "@/components/rentals/TopDestinations";
import Rentals from "@/components/rentals/Rentals";
import HotelTypes from "@/components/rentals/HotelTypes";
...
export default dynamic(() => Promise.resolve(HolidayRental), { ssr: false });
