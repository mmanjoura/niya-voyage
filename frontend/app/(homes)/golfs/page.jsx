...
import GolfFooter from "@/components/footer/golf-footer";
import GolfHeader from "@/components/header/golf-header";
import GolfHero from "@/components/hero/golf-hero";
import TopHeader from "@/components/header/header-9/top-header";
import Blog4 from "@/components/blog/Blog4";
import Testimonial from "@/components/golf/Testimonial";
import PopularDestinations from "@/components/golf/PoularDestinations";
import Golf2 from "@/components/golf/Golf2";
import Link from "next/link";
import AboutIntro from "@/components/golf/AboutIntro";
import WhyChoose from "@/components/golf/WhyChoose";
import Golf3 from "@/components/golf/Golf3";
...
export default dynamic(() => Promise.resolve(golf), { ssr: false });
