...
import CarFooter from "@/components/footer/car-footer";
import CarHeader from "@/components/header/car-header";
import CarHero from "@/components/hero/car-hero";
import BlockGuide from "@/components/cars/BlockGuide";
...
import TopDestinations from "@/components/cars/TopDestinations";
import Counter4 from "@/components/counter/Counter4";
import Faq from "@/components/faq/Faq";
import AppBanner from "@/components/cars/AppBanner";
import Blog from "@/components/cars/Blog";
...
export default dynamic(() => Promise.resolve(car), { ssr: false });
