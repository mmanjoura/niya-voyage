  ...
  return (
    <nav className="menu js-navList">
      <ul className={`menu__nav ${style} -is-active`}>
        ...
        <li className={pathname === "/holiday-rentals" ? "current" : ""}>
          <Link href="/holiday-rentals">Holiday-Rentals</Link>
        </li>
        ...
        <li className={pathname === "/golfs" ? "current" : ""}>
          <Link href="/golfs">Golfs</Link>
        </li>
