...
func FindBooks(c *gin.Context) {
	...
	database.Database.DB.Offset(offset).Limit(limit).Find(&books)
...
func FindBook(c *gin.Context) {
	...
	if err := database.Database.DB.Where("id = ?", c.Param("id")).First(&book).Error; err != nil {
...
func UpdateBook(c *gin.Context) {
	...
	database.Database.DB.Model(&book).Updates(models.Book{Title: input.Title, Author: input.Author})
...
func DeleteBook(c *gin.Context) {
	...
	database.Database.DB.Delete(&book)
